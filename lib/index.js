...
var LoadsContext = React.createContext({
  cache: {
    records: {},
    get: function get() {},
    set: function set() {},
...
function Provider(_ref) {
  ...
  var reset = React.useCallback(function (opts) {
    setRecords({});
  ...
  var set = React.useCallback(function (key, val, opts) {
  ...
  var get = React.useCallback(function (key, opts) {
  ...
  return React.createElement(LoadsContext.Provider, {
    value: value
  }, children);
}
...
function useLoads(fn) {
  ...
  var globalContext = React.useContext(LoadsContext);
...
Loads.Idle = function (props) {
  return React.createElement(StateContext.Consumer, null, function (loader) {
...
function useLoadsCache(contextKey) {
  var context = React.useContext(LoadsContext);
...
exports.Loads = Loads;
exports.LoadsContext = LoadsContext$1;
exports.Provider = Provider;
exports.useLoads = useLoads;
exports.useLoadsCache = useLoadsCache;
